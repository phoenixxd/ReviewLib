...
function responsegen(clientresp, button_name){
    //code goes here
    ...
    var app_html = "<div class= 'response-msg'>Im still learning, check an example<br><button id='" + button_name + "' style='align-self:center;'>Show Features</button></div>";
...
function regbuttonclick(pos1,pos2,pos3,pos4,neg1,neg2,neg3,neg4,specs_list,button_name){
    var button1 = document.getElementById(button_name);
